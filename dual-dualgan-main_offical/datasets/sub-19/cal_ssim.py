...
for i in range(1, 101, 10):
    # 示例用法
    ssim_score = duibi(
        "E:\\second_paper\\dual-dualgan-main_offical\\datasets\\sub-19\\test\\C\\C_"+str(i)+".png",
        "E:\\second_paper\\dual-dualgan-main_offical\\test\\sub-19-img_sz_256-fltr_dim_64-L1-lambda_BC_1000.0_1000.0\\B\\B_" + str(
            i) + "_B2C.jpg",
        i,
