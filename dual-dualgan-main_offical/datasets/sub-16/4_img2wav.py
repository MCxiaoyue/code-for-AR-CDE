...
file_names = [i for i in range(1, 130, 10)]
...
for name in file_names:
    ...
    input_image = Image.open("E:\\second_paper\\dual-dualgan-main_offical\\test\\sub-16-img_sz_256-fltr_dim_64-L1-lambda_BC_1000.0_1000.0\\B\\B_" + str(name) + "_B2C.jpg")
