...
class EVRNet(nn.Module):
    def __init__(self, num_classes, lstm_hidden_size=512, num_lstm_layers=1):
        super(EVRNet, self).__init__()
        # LSTM layer(s)
        self.lstm_hidden_size = lstm_hidden_size
        self.num_lstm_layers = num_lstm_layers
        self.lstm = nn.LSTM(input_size=124, hidden_size=self.lstm_hidden_size, num_layers=self.num_lstm_layers,
                            batch_first=True)
...
subjects = ['10']  # 添加所有需要处理的主题ID  , '12', '11', '17'
...
# 测试数据的索引
test_indices = [i for i in range(0, 121, 10)]  # [6, 9, 8, 110, 111, 112]
