...
import TensorCSPNet_pak.geoopt as geoopt
import TensorCSPNet_pak.geoopt.utils  #
from TensorCSPNet_pak.geoopt.manifolds.base import Manifold, ScalingInfo
import functools
...
class Scaled(Manifold):
    ...
    >>> import TensorCSPNet_pak.geoopt as geoopt, torch, numpy as np
