...
class EVRNet(nn.Module):
    def __init__(self, num_classes, dropout_prob=0.1):
        ...
        #     d_input=124,  # Dimension of each vector in the input sequence (i.e. token size)
        ...
        self.fc_layer = nn.Linear(124, num_classes)  # 调整线性层的输入大小
...
subjects = ['22']  # 添加所有需要处理的主题ID  , '12', '11', '17'
...
optimizer = optim.Adam(model.parameters(), lr=1e-4)  # betas=(0.95, 0.999), eps=1e-08, weight_decay=1e-4
