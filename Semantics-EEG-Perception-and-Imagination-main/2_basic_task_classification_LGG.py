...
from LGG_pak.networks import LGGNet
...
original_order = ["Fp1", "Fpz", "Fp2", "F7", "F3", "Fz", "F4", "F8", "FC5", "FC1", "FC2", "FC6", "M1", "T7", "C3", "Cz", "C4",
...
['P5'], ['P1'], ['P2'], ['P6'], ['PO3'], ['PO4'], ['FT7'], ['FT8'],
['TP7'], ['TP8'], ['PO7'], ['PO8'], ['FT9'], ['FT10'], ['TPP9h'],
['TPP10h'], ['PO9'], ['PO10'], ['P9'], ['P10'], ['AFF1'], ['AFz'],
['AFF2'], ['FFC5h'], ['FFC3h'], ['FFC4h'], ['FFC6h'], ['FCC5h'],
['FCC3h'], ['FCC4h'], ['FCC6h'], ['CCP5h'], ['CCP3h'], ['CCP4h'],
['CCP6h'], ['CPP5h'], ['CPP3h'], ['CPP4h'], ['CPP6h'], ['PPO1'],
['PPO2'], ['I1'], ['Iz'], ['I2'], ['AFp3h'], ['AFp4h'], ['AFF5h'],
['AFF6h'], ['FFT7h'], ['FFC1h'], ['FFC2h'], ['FFT8h'], ['FTT9h'],
['FTT7h'], ['FCC1h'], ['FCC2h'], ['FTT8h'], ['FTT10h'], ['TTP7h'],
['CCP1h'], ['CCP2h'], ['TTP8h'], ['TPP7h'], ['CPP1h'], ['CPP2h'],
['TPP8h'], ['PPO9h'], ['PPO5h'], ['PPO6h'], ['PPO10h'], ['POO9h'],
['POO3h'], ['POO4h'], ['POO10h'], ['OI1h'], ['OI2h']
]
graph_idx = graph_general_DEAP
idx = []
...
image_data_array = image_data_array[:, idx, :]
...
model = LGGNet(
    ...
    input_size=(1, image_data_array.shape[1], image_data_array.shape[2]),
    sampling_rate=1024,
...
for epoch in range(num_epochs):
    ...
    if test_accuracy > best_test_acc:
        ...
        torch.save(best_model_weights,
                   'classification_checkpoint/' + str(subjects[0]) + '/LGG/best_model_weights.pth')
...
# 训练完成后，使用最佳模型权重更新模型
model.load_state_dict(torch.load('./classification_checkpoint/' + str(subjects[0]) + '/LGG/best_model_weights.pth'))
model.eval()
...
# 在训练完成后调用此函数
plot_and_save_loss_curves(train_losses, test_losses, filename='classification_checkpoint/' + str(subjects[0]) + '/LGG/loss_curves.png')
