...
from tqdm import tqdm
from braindecode.models import EEGNetv1, ATCNet, EEGConformer, EEGITNet, ShallowFBCSPNet, EEGConformer, EEGInception
import random
...
# 初始化模型、损失函数和优化器
num_classes = 3
model = CustomEEGConformer(num_classes=num_classes, in_chans=124, input_window_samples=2049).to(device)  # 将模型移动到 GPU
