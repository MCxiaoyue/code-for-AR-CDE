...
if __name__ == '__main__':
    ...
    original_order = ['Fp1', 'Fp2', 'F3', 'F4', 'C3', 'C4', 'P3', 'P4', 'O1', 'O2', 'F7', 'F8',
    ...
    graph_general_DEAP = [['Fp1'], ['Fp2'], ['F3'], ['F4'], ['C3'], ['C4'], ['P3'], ['P4'],
                          ['O1'], ['O2'], ['F7'], ['F8'], ['T3'], ['T4'], ['T5'], ['T6'],
                          ['Sp1'], ['Sp2'], ['Fz'], ['Cz'], ['Pz'], ['Oz'], ['A1'], ['A2']]

    # graph_general_DEAP = [['Fp1', 'Fp2', 'F3', 'F4', 'Fz'], ['C3', 'Cz', 'C4'],
    #                       ['P3', 'Cz', 'P4'], ['O1', 'Oz', 'O2'], ['F7', 'T3', 'T5', 'F8', 'T4', 'T6'],
    #                       ['A1', 'A2'], ['Sp1', 'Sp2']]
    ...
    for epoch in range(num_epochs):
        ...
        if test_accuracy > best_test_acc:
            ...
            # 立即保存最佳模型权重到文件
            torch.save(best_model_weights, './classification_checkpoint/LGG/best_model_weights.pth')
    ...
    # 训练完成后，使用最佳模型权重更新模型
    model.load_state_dict(torch.load('./classification_checkpoint/LGG/best_model_weights.pth'))
    model.eval()
    ...
    # 在训练完成后调用此函数
    plot_and_save_loss_curves(train_losses, test_losses, filename='classification_checkpoint/LGG/loss_curves.png')
