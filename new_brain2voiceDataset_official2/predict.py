...
def predict():
    ...
    G_A = torch.load('public_dataset/sub-19/checkpoint/generator_a.pkl')
    ...
    for X, labelx in iter(testA_loader):
        ...
        save_image(g_a, "./public_dataset/sub-19/test_AtoB_results/AtoB_" + labelx[2][0].split('.')[0].split('_')[1] + '.PNG')
